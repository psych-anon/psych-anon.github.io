...
function demo() {
	...
	this.info = {
		...
		"race":{
			...
			"demo":"DEMOrace",
			"warning":"REQrace",
			"HTML":"With which race/ethnicity do you most identify?<p style=\"display:none\" class=\"required\" id = \"REQrace\">This is a required field.</p><br><input class=\"race\" type=\"checkbox\" name=\"AboriginalIndigenous\">Aboriginal/Indigenous or Native American/Alaska Native<br><input class=\"race\" type=\"checkbox\" name=\"Black\">Black or African-American<br><input class=\"race\" type=\"checkbox\" name=\"EastAsian\">East Asian<br><input class=\"race\" type=\"checkbox\" name=\"PacificIslander\">Native Hawaiian or Other Pacific Islander<br><input class=\"race\" type=\"checkbox\" name=\"SouthAsian\">South Asian<br><input class=\"race\" type=\"checkbox\" name=\"White\">White<br><input class=\"race\" type=\"checkbox\" name=\"Other\">Other<br><input class=\"race\" type=\"checkbox\" name=\"Decline\">I do not wish to provide this information<br><br>",
			"value":""
		},
		"sexOrientation":{
			"name":"sexOrientation",
			...
			"HTML":"What sexual orientation do you most identify with?<p style=\"display:none\" class=\"required\" id=\"REQsexOrientation\">This is a required field.</p><br><select name=\"sexOrientation\"><option value=\"\"></option><option value=\"Heterosexual\">Heterosexual</option><option value=\"Gay\">Gay</option><option value=\"Lesbian\">Lesbian</option><option value=\"Bisexual\">Bisexual</option><option value=\"Asexual\">Asexual</option><option value=\"Queer\">Queer</option><option value=\"Questioning\">Questioning</option><option value=\"Other\">Not Otherwise Specified</option><option value=\"Decline\">I do not wish to provide this information</option></select><br><br>",
			"value":""
		},
		"weightLoss":{
			"name":"weightLoss",
		...
		"whatResponseStyle":{
			"name":"whatResponseStyle",
			"include":false,
			"type":"textarea",
			"warning":"REQwhatResponseStyle",
			"HTML":"What criteria did you use to make your decisions?<br>Please briefly explain how you made your decision for each person.<p style=\"display:none\" class=\"required\" id = \"REQwhatResponseStyle\"> This is a required field.</p><br><textarea name=\"whatResponseStyle\"></textarea><br><br>",
			"value":""
		}
	};
